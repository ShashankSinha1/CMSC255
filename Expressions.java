public class Expressions 
{
  public static void main(String[] args)
  {
    ...
    /**********************************************************
     * Double ++ signs mean a preincrement meaning the value of the variable will be raised by 1
     * 1 is added to 3 so the new value displayed is 4
    ***********************************************************/

    System.out.println("#3 " + (++a));       

    /**********************************************************
     * Double -- signs mean a predecrement meaning the value of the variable will decrease by 1
