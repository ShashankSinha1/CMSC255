...
public class Project6EnumTests {
    ...
    public void SizeTest() {
        ...
        assertEquals("When looking at the number of values in the Size enum, we",4,
                Size.values().length);
    }
    ...
    public void CrustTest() {
        ...
        assertEquals("When looking at the number of values in the Crust enum, we",4,
                Crust.values().length);
    }
    ...
    public void SauceTest() {
        ...
        assertEquals("When looking at the number of values in the Sauce enum, we",2,
                Sauce.values().length);
    }
    ...
    public void MeatToppingTest() {
        ...
        assertEquals("When looking at the number of values in the MeatTopping enum, we",6,
                MeatTopping.values().length);
    }
    ...
    public void VeggieToppingTest() {
        ...
        assertEquals("When looking at the number of values in the VeggieTopping enum, we",6,
                VeggieTopping.values().length);
    }
